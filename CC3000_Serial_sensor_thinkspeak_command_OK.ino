...
// What page to grab!
#define WEBSITE      "192.168.100.7"  // ex. "www.adafruit.com"
#define WEBPAGEDATA      "/commandData/command.php"     // ex. "/testwifi/index.html"
#define WEBPAGECMD      "/commandData/commandData.php"     // ex. "/testwifi/index.html"
/************************/
...
void setup(void)
{
  ...
  ip = 0xC0A86407;      /*"www.ab126.com/system/2859.html"*/
...
void uploadDataTest(){
  delay(10000);
  Serial.print("upload uploadDataTest()");
}
